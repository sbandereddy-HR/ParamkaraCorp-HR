// ParamkaraCorp-HR Agent — v6 (VERCEL)
// Converted from Netlify Functions → Vercel API Routes
...
const SCHEMAS = {
  ...
  "skill_match": {
    "present": boolean, "match_percentage": number|null,
    "mandatory_skills_met": number|null, "mandatory_skills_total": number|null,
    "recommendation": "SHORTLIST"|"MAYBE"|"REJECT"|null, "recommendation_reason": "string|null",
  ...
  "gap_analysis": {
    ...
    "total_gap_months": number, "verdict": "CLEAN"|"GAPS_FOUND"
  },
  "ctc_check": {
    "present": boolean, "claimed_ctc_lpa": number|null,
  ...
  "epfo_check": {"present": boolean, "verdict": "MATCH"|"PARTIAL"|"MISMATCH"|null, "verdict_reason": "string|null", "inflation_years": number|null, "red_flags": ["string"]},
  "offer_check": {"present": boolean, "verdict": "AUTHENTIC"|"SUSPICIOUS"|"FAKE"|null, "overall_score": number|null, "verdict_reason": "string|null"},
  "fraud_risk": "LOW"|"MEDIUM"|"HIGH",
  "fraud_signals": ["string"], "positive_signals": ["string"],
  "final_decision": "HIRE"|"MAYBE"|"REJECT", "final_decision_reason": "string"
}`,

  resume_only: `{
  "type": "employment", "mode": "gap_analysis",
  "candidate_name": "string|null",
  "companies": [{"company": "string", "from": "YYYY-MM", "to": "YYYY-MM|Present", "role": "string"}],
  "gaps": [{"from_company": "string", "to_company": "string", "gap_months": number, "severity": "SHORT"|"MEDIUM"|"LONG", "label": "string"}],
  "total_gap_months": number, "total_experience_years": number,
  "verdict": "CLEAN"|"GAPS_FOUND", "verdict_reason": "string", "red_flags": ["string"]
}`,
  ...
  "scorecard": {
    "match_percentage": number, "mandatory_skills_met": number, "mandatory_skills_total": number,
  ...
  multi_rank: `{
  "type": "multi_rank", "role": "string", "jd_skills": ["skill1", "skill2"],
  "candidates": [
  ...
  offer_letter: `{
  "type": "offer_letter", "overall_score": number,
  "verdict": "AUTHENTIC"|"SUSPICIOUS"|"FAKE", "verdict_reason": "string",
  "checks": {
  ...
  "claimed_ctc": number, "claimed_ctc_lpa": number,
  "overall_verdict": "GENUINE"|"SUSPICIOUS"|"HIGHLY_INFLATED"|"INSUFFICIENT_DATA",
  "overall_verdict_reason": "string", "confidence": "HIGH"|"MEDIUM"|"LOW",
  "sources_used": ["salary_slip"|"pf_history"|"bank_statement"],
  "salary_slip": {
    "present": boolean, "verdict": "GENUINE"|"SUSPICIOUS"|"FAKE"|null, "overall_score": number|null,
    ...
    "inflation_verdict": "NORMAL"|"INFLATED"|"HIGHLY_INFLATED"|"NO_DATA"|null, "red_flags": ["string"]
  },
  "pf_analysis": {
  ...
  "red_flags": ["string"], "positive_signals": ["string"]
}`,

  epfo_crosscheck: `{
  "type": "employment", "mode": "epfo_crosscheck",
  "candidate_name": "string|null",
  ...
  "verdict": "MATCH"|"PARTIAL"|"MISMATCH", "verdict_reason": "string", "red_flags": ["string"]
}`,

  multi_resume_nojd: `{
  "type": "multi_resume_nojd", "message": "string",
  "candidates": [
    {"name": "string", "total_experience_years": number, "current_role": "string",
     "companies": [{"company": "string", "from": "YYYY-MM", "to": "YYYY-MM|Present", "role": "string"}],
  ...
  unknown_docs: `{
  "type": "unknown", "detected_content": "string",
  "findings": ["string"], "verdict": "string", "red_flags": ["string"]
}`,
};
...
// ── VERCEL HANDLER ─────────────────────────────────────────────────────────────
// This replaces the Netlify exports.handler
module.exports = async function handler(req, res) {
  ...
  try {
    // Vercel auto-parses JSON body — no need for JSON.parse(event.body)
    const { message, documents, history, claimedCTC } = req.body || {};
    ...
    const tokenLimit =
      analysisMode === "full_analysis"    ? 4500 :
      ...
      analysisMode === "jd_resume"        ? 3000 : 2500;

    auditLog("analysis_start", { requestId, analysisMode, model, tokenLimit, docCount: limitedDocs.length, docTypes: limitedDocs.map(d => d.detectedType) });
    ...
    result._meta = {
      request_id: requestId, docs_analyzed: limitedDocs.length, docs_dropped: droppedCount,
      analysis_mode: analysisMode, model_used: model, vision_fallback: visionFallback,
    };
